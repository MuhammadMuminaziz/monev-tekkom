                                    ...
                                    <div class="container mt-5">
                                        ...
                                        <div class="form-group row">
                                            <label for="npsn" class="col-sm-4 col-form-label">Nomor Pokok Sekolah Nasional
                                                (NPSN)</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control @error('npsn') is-invalid @enderror" id="npsn" name="npsn" placeholder="" value="{{ old('npsn') }}">
                                                @error('npsn')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-sm-5">
                                                        <select class="custom-select @error('unbk') is-invalid @enderror" id="unbk" name="unbk">
                                                            ...
                                                            <option {{ old('unbk') == 'Sudah' ? 'selected' : '' }} value="Sudah">Sudah</option>
                                                            <option {{ old('unbk') == 'Belum' ? 'selected' : '' }} value="Belum">Belum</option>
                                                        </select>
                                                    </div>
                                                    @error('unbk')
                                                    <div class="invalid-feedback">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control @error('transportasi') is-invalid @enderror" id="transportasi" name="transportasi" placeholder="" value="{{ old('transportasi') }}">
                                                @error('transportasi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="internet" class="col-sm-4 col-form-label">Fasilitas Komunikasi Internet
                                                Saat Ini</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control @error('internet') is-invalid @enderror" id="internet" name="internet" placeholder="" value="{{ old('internet') }}">
                                                @error('internet')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="custom-select @error('bantuan_teknologi') is-invalid @enderror"  id="bantuan_teknologi" name="bantuan_teknologi">
                                                    <option selected disabled value="">Pilih</option>
                                                    <option {{ old('bantuan_teknologi') == 'Pernah' ? 'selected' : '' }}>Pernah</option>
                                                    <option {{ old('bantuan_teknologi') == 'Tidak Pernah' ? 'selected' : '' }}>Tidak Pernah</option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8 page-input">
                                                <input type="text" class="form-control @error('nama_lembaga') is-infalid @enderror mb-1"  name="nama_lembaga[]" id="nama_lembaga" placeholder="" multiple>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="custom-select @error('listrik') is-invalid @enderror" id="listrik" name="listrik">
                                                    <option selected disabled value="">Pilih</option>
                                                    <option {{ old('listrik') == 'Ada' ? 'selected' : '' }}>Ada</option>
                                                    <option {{ old('listrik') == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                                </select>
                                                @error('listrik')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="custom-select @error('power_suplay') is-invalid @enderror" id="power_suplay" name="power_suplay">
                                                    <option selected disabled value="">Pilih</option>
                                                    <option {{ old('power_suplay') == 'PLN' ? 'selected' : '' }}>PLN</option>
                                                    <option {{ old('power_suplay') == 'Genset' ? 'selected' : '' }}>Genset</option>
                                                    <option {{ old('power_suplay') == 'Solar Cell' ? 'selected' : '' }}>Solar Cell</option>
                                                </select>
                                                @error('power_suplay')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                    ...
                                    <div class="container mt-5">
                                        ...
                                        <div class="form-group row">
                                            <label for="jenis_program" class="col-sm-4 col-form-label">Jenis Program / Kegiatan yang
                                                diterima</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control @error('jenis_program') is-invalid @enderror" id="jenis_program" name="jenis_program" placeholder="" value="{{ old('jenis_program') }}">
                                                @error('jenis_program')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="custom-select @error('lan') is-invalid @enderror" id="lan" name="lan">
                                                    <option selected disabled value="">Pilih</option>
                                                    <option {{ old('lan') == 'Ada' ? 'selected' : '' }}>Ada</option>
                                                    <option {{ old('lan') == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                                </select>
                                                @error('lan')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="custom-select @error('router') is-invalid @enderror" id="router" name="router">
                                                    <option selected disabled value="">Pilih</option>
                                                    <option {{ old('router') == 'Ada' ? 'selected' : '' }}>Ada</option>
                                                    <option {{ old('router') == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                                </select>
                                                @error('router')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="custom-select @error('komputer') is-invalid @enderror" id="komputer" name="komputer">
                                                    <option selected disabled value="">Pilih</option>
                                                    <option {{ old('komputer') == 'Ada' ? 'selected' : '' }}>Ada</option>
                                                    <option {{ old('komputer') == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                                </select>
                                                @error('komputer')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                                <select class="custom-select @error('internet_speed') is-invalid @enderror" id="" name="internet_speed">
                                                    <option selected disabled value="">Pilih</option>
                                                    <option {{ old('internet_speed') == 'Kbps' ? 'selected' : '' }}>Kbps</option>
                                                    <option {{ old('internet_speed') == 'Mbps' ? 'selected' : '' }}>Mbps</option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control @error('alasan_tambah_kuota') is-invalid @enderror" id="alasan_tambah_kuota" name="alasan_tambah_kuota"
                                                    rows="6">{{ old('alasan_tambah_kuota') }}</textarea>
                            ...
                            <div class="tab-pane fade" id="kuisioner_data" role="tabpanel"
                                ...
                                <div class="container mt-5">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="tingkat_sekolah"
                                                    id="sd" value="SD" {{ old('tingkat_sekolah') == 'SD' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="tingkat_sekolah"
                                                    id="smp" value="SMP" {{ old('tingkat_sekolah') == 'SMP' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="tingkat_sekolah"
                                                    id="sma" value="SMA" {{ old('tingkat_sekolah') == 'SMA' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="tingkat_sekolah"
                                                    id="smk" value="SMK" {{ old('tingkat_sekolah') == 'SMK' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control @error('date_responden') is-invalid @enderror" id="" name="date_responden" placeholder="" value="{{ old('date_responden') }}">
